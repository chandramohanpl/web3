...
describe("Dappazon", () => {
    ...
    //0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 (deployer account address from hardhat)
    describe("Deployment", () => {
    ...
    describe("Buying", () => {
      ...
      beforeEach(async () => {
        ...
        // Buy a item
        let buyerContract = await dappazon.connect(buyer);
        transaction = await buyerContract.buy(ID, { value: COST })
        await transaction.wait()
      })
