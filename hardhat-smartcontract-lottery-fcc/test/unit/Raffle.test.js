...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("performUpkeep", function () {
              ...
              it("updates the raffle state, emits a requestId and calls the vrf coordinator", async () => {
                  ...
                  await new Promise(async (resolve, reject) => {
                      raffle.once("WinnerPicked", async () => {
                          ...
                          try {
                              ...
                              console.log(`ACCOUNT 0: %S`, accounts[0])
                              console.log(`ACCOUNT 1: %S`, accounts[1])
                              console.log(`ACCOUNT 3: %S`, accounts[3])
